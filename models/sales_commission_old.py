    ...
    def get_commission_type(self):
        ...
        for rec in self:
            if rec.sales_commission_line:
                ...
                rec.type = False
    #@api.multi
    @api.depends('sales_commission_line', 'sales_commission_line.state','sales_commission_line.amount')
...
#        'account.invoice',
    ...
    # ownership_contracts = fields.One2many('ownership.contract','sale_commission_id',string='Owner Contract')
    # ownership_contracts = fields.Many2many('ownership.contract',string='Owner Contract',order="date_payment desc")
    ...
    def invoice_line_create(self, invoice_id):
        ...
        for rec in self:
            ...
            print(f'in invoice_line_create - vals :{vals}')
            invoice_id.write({
...
#         return invoice_vals
    ...
    def _prepare_invoice(self):
        ...
        if self.commission_user_id:
            ...
            print(f'in _prepare_invoice - broker_id :{self.broker_id} ')
            ...
            print(f'in _prepare_invoice - partner third_party_id:{partner} ')
